<nav class="pcoded-navbar">
  ...
  <div class="pcoded-inner-navbar main-menu">
      ...
      <ul class="pcoded-item pcoded-left-item">
          ...
          <li>
              <a href="calendar" class="waves-effect waves-dark">
          ...
          <li>
              <a href="storage" class="waves-effect waves-dark">
                  <span class="pcoded-micon"><i class="ti-cloud-up"></i><b>D</b></span>
                  <span class="pcoded-mtext" data-i18n="nav.dash.main">Storage</span>
                  <span class="pcoded-mcaret"></span>
              </a>
          </li>
          <li>
              <a href="lgu" class="waves-effect waves-dark">
                  <span class="pcoded-micon"><i class="ti-notepad"></i><b>D</b></span>
                  <span class="pcoded-mtext" data-i18n="nav.dash.main">LGU Information</span>
                  <span class="pcoded-mcaret"></span>
              </a>
          </li>
          <li>
